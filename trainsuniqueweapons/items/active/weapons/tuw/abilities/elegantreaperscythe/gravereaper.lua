...
GraveReaper = WeaponAbility:new()

function GraveReaper:init()
  self.cooldownTimer = self.cooldownTime
end

function GraveReaper:update(dt, fireMode, shiftHeld)
